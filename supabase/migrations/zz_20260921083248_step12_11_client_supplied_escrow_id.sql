-- ============================================================================
-- step12_11_client_supplied_escrow_id   [Step 12.11 — migration-ফাইল-সিঙ্ক, Step 12.12]
-- ============================================================================
-- এটা live Supabase প্রজেক্টে (mghvvpndkxnscwryfkib) ইতিমধ্যে apply-করা migration
-- `20260921083248 step12_11_client_supplied_escrow_id`-এর repo-কপি। live-ই সত্যের উৎস: নিচের SQL live pg_proc (MCP,
-- ২০২৬-০৯-২১) থেকে টেনে যাচাই করা — প্রতিটা ফাংশন-বডির md5(prosrc) live-এর সাথে বাইট-বাই-বাইট মিলেছে।
-- কী বদলায়: accept_bid(…, p_escrow_id text DEFAULT NULL) ও accept_direct_contract(p_problem_id, p_escrow_id text DEFAULT NULL) — client-এর ESCROW_<id> cloud escrow-এর id হয়; পুরনো ৫-arg/১-arg overload একই migration-এ DROP।
-- live md5(prosrc) accept_bid(…6-arg): c943d3d874cd0c1fecedd7a8e7f4c437
-- live md5(prosrc) accept_direct_contract(text,text): 4ffd85dbba7903182caf8974c08eeb38
